...
2. LEVEL 1 — Run automated scan:
   python3 ~/.agents/skills/skill-generator/scripts/security-scan.py <skill-path>
3. Check exit code:
...
2. **LEVEL 1** — Run automated scanner:
   ```bash
   python3 ~/.agents/skills/skill-generator/scripts/security-scan.py <path>
   ```
...
```bash
python3 ~/.agents/skills/skill-generator/scripts/security-scan.py ./skill-name/
```
